export const ACTIONS = [
  ...
  { id: "flyers", art: "passport", tab: "Работа", title: "Раздавать листовки", detail: "Без документов · 170 ₴ за смену", effects: { money: 170, workShifts: 1, food: -4, energy: -10, joy: -2, time: 4 }, event: "Несколько часов на ногах — и первая простая смена позади." },
  ...
  { id: "loader", art: "warehouse", tab: "Работа", title: "Разгрузить товар", detail: "Тяжёлая подработка · 320 ₴", effects: { money: 320, workShifts: 1, food: -7, health: -2, energy: -22, time: 6 }, event: "Спина гудит, но за честную тяжёлую работу заплатили сразу." },
  { id: "cleaner", art: "clinic", tab: "Работа", title: "Смена уборщиком", detail: "Нужен паспорт · 300 ₴", requires: ["passport"], effects: { money: 300, workShifts: 1, food: -6, energy: -18, time: 5 }, event: "Обычная рабочая смена. Не мечта, но уже стабильнее улицы." },
  { id: "dishwasher", art: "canteen", tab: "Работа", title: "Мыть посуду", detail: "Паспорт · 360 ₴", requires: ["passport"], effects: { money: 360, workShifts: 1, food: -7, energy: -20, joy: -2, time: 6 }, event: "Гора тарелок закончилась. Смена оплачена." },
  { id: "courier_walk", art: "bike", tab: "Работа", title: "Курьер пешком", detail: "Паспорт, 2 смены · 350 ₴", requires: ["passport"], minShifts: 2, effects: { money: 350, workShifts: 1, food: -7, energy: -20, time: 6 }, event: "Ты разнёс заказы по городу и заработал первые деньги на доставке." },
  { id: "warehouse_shift", art: "warehouse", tab: "Работа", title: "Смена на складе", detail: "Паспорт, 2 смены · 480 ₴", requires: ["passport"], minShifts: 2, effects: { money: 480, workShifts: 1, food: -8, health: -1, energy: -24, time: 8 }, event: "Полная смена на складе закончилась. Тяжело, зато оплата уже серьёзнее." },
  { id: "courier_bike", art: "bike", tab: "Работа", title: "Курьер на велосипеде", detail: "Паспорт, велосипед, 3 смены · 520 ₴", requires: ["passport", "bike"], minShifts: 3, effects: { money: 520, workShifts: 1, food: -8, energy: -18, joy: 1, time: 6 }, event: "С велосипедом доставок стало больше, а город — немного меньше." },
  { id: "barista", art: "coffee", tab: "Работа", title: "Работать бариста", detail: "Паспорт, аттестат, 4 смены · 540 ₴", requires: ["passport", "diploma"], minShifts: 4, effects: { money: 540, workShifts: 1, food: -7, energy: -18, joy: 1, reputation: 1, time: 8 }, event: "Первый день за стойкой прошёл неплохо. Постоянные гости начали узнавать тебя." },
  { id: "seller", art: "sneakers", tab: "Работа", title: "Работать продавцом", detail: "Паспорт, аттестат, 5 смен · 580 ₴", requires: ["passport", "diploma"], minShifts: 5, effects: { money: 580, workShifts: 1, food: -7, energy: -17, joy: -1, reputation: 1, time: 8 }, event: "Ты отработал полноценную смену в магазине." },
  { id: "mechanic_helper", art: "cars", tab: "Работа", title: "Помощник механика", detail: "Паспорт, аттестат, 6 смен · 620 ₴", requires: ["passport", "diploma"], minShifts: 6, effects: { money: 620, workShifts: 1, food: -8, health: -1, energy: -21, reputation: 1, time: 8 }, event: "Сегодня ты уже не просто подаёшь инструменты — начинаешь понимать ремесло." },
  { id: "support_operator", art: "study", tab: "Работа", title: "Оператор поддержки", detail: "Паспорт, аттестат, жильё от комнаты, 8 смен · 700 ₴", requires: ["passport", "diploma"], minHousing: "room", minShifts: 8, effects: { money: 700, workShifts: 1, food: -6, energy: -16, joy: -2, reputation: 1, time: 8 }, event: "Восемь часов разговоров закончились. Это уже похоже на обычную стабильную работу." },
  { id: "guard", tab: "Работа", title: "Смена охранником", detail: "Паспорт, аттестат, жильё от комнаты, 6 смен · 680 ₴", requires: ["passport", "diploma"], minHousing: "room", minShifts: 6, effects: { money: 680, workShifts: 1, food: -8, energy: -22, joy: -4, reputation: 1, time: 8 }, event: "Спокойная смена. Зарплата получена." },
...
export function available(action, state) {
  ...
  if (action.minHousing) {
    const order = ["street", "box", "room", "apartment"];
    if (order.indexOf(housingTier(state)) < order.indexOf(action.minHousing)) reasons.push(`Жильё: от ${label(action.minHousing)}`);
  }
