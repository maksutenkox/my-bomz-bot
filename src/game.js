export const ACTIONS = [
  ...
  { id: "bottles", tab: "Работа", title: "Сдать бутылки", detail: "Небольшой честный заработок", effects: { money: 14, food: -4, health: -2, energy: -12, time: 4 }, event: "Ты собрал и сдал бутылки." },
  { id: "cars", tab: "Работа", title: "Помыть машины", detail: "Подработка на улице", effects: { money: 24, food: -6, energy: -17, joy: -3, time: 5 }, event: "К концу смены руки устали, зато появились деньги." },
  ...
  { id: "apartment", tab: "Жильё", title: "Снять квартиру", detail: "Паспорт и 120 ₽. Аренда 20 ₽ в день", cost: 120, requires: ["passport"], once: true, gives: "apartment", effects: { joy: 18, health: 8, time: 5 }, event: "Наконец появились собственные четыре стены." },
  ...
  { id: "street_trade", tab: "Теневая сторона", title: "Рискованная сделка", detail: "Быстрые деньги, растёт внимание", effects: { money: 42, heat: 12, reputation: -4, joy: -3, energy: -9, time: 3 }, event: "Сделка состоялась. Теперь за тобой внимательнее следят." },
...
export function newGame(name = "Герой") {
  return { name, day: 1, hour: 8, age: 25, food: 55, health: 75, joy: 55, energy: 65, money: 0, reputation: 0, heat: 0, study: 0, investments: 0, owned: [], log: ["День 1. Всё начинается с одного решения."], ended: false };
}
